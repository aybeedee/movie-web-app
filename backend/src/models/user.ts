...
export class User extends Model<UserAttributes, UserCreationAttributes> implements UserAttributes {
  ...
  setMovieIdMovies!: Sequelize.BelongsToManySetAssociationsMixin<Movie, MovieId>;
  addMovieIdMovie!: Sequelize.BelongsToManyAddAssociationMixin<Movie, MovieId>;
  addMovieIdMovies!: Sequelize.BelongsToManyAddAssociationsMixin<Movie, MovieId>;
  createMovieIdMovie!: Sequelize.BelongsToManyCreateAssociationMixin<Movie>;
  removeMovieIdMovie!: Sequelize.BelongsToManyRemoveAssociationMixin<Movie, MovieId>;
  removeMovieIdMovies!: Sequelize.BelongsToManyRemoveAssociationsMixin<Movie, MovieId>;
  hasMovieIdMovie!: Sequelize.BelongsToManyHasAssociationMixin<Movie, MovieId>;
  hasMovieIdMovies!: Sequelize.BelongsToManyHasAssociationsMixin<Movie, MovieId>;
