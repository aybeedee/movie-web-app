...
export function initModels(sequelize: Sequelize) {
  ...
  Movie.belongsToMany(User, { as: 'userIdUsers', through: Review, foreignKey: "movieId", otherKey: "userId" });
  User.belongsToMany(Movie, { as: 'movieIdMovies', through: Review, foreignKey: "userId", otherKey: "movieId" });
